...
# TODO: Finish
async def query_openlibrary(sess: aiohttp.ClientSession,
                            query: str) -> OpenLibraryResponse:
...
class BookSearchPlugin(commands.Cog):
    ...
    @commands.slash_command(name="booksearch",
                            description="Uses the OpenLibrary API to search for books")
    async def book_search(self, ctx: disnake.ApplicationCommandInteraction, *,
